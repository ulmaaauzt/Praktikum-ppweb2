...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2025 at 10:09 AM
...
INSERT INTO `kelurahan` (`id`, `nama`, `kelurahan_id`) VALUES
(1, 'Grogol', 1),
(2, 'Beji', 2),
(3, 'Sawangan', 3),
(4, 'Banten', 4);
...
CREATE TABLE `paramedik` (
  ...
  `kategori` enum('dokter','perawat','bidan','lainnya') DEFAULT NULL,
...
(3, '001', 'Achio Seana', 'Los Santos', '2003-10-06', 'P', 'seana@gmail.com', 'Willowfield 06', 2),
(4, '002', 'Nara', 'Los Santos', '2007-04-11', 'P', 'nara@gmail.com', 'Kp durian runtuh', 4);
